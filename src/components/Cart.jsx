...
export default function Cart({ shoes = [] }) {
  const { id, img, name, price, originalPrice, rating, detail } =
    shoes;
      ...
      <div className="product" key={id}>
        ...
        <div className="product-body">
          ...
          <div className="product-price">
            ${price}{" "}
            <span className="product-original-price">Was ${originalPrice}</span>
          </div>
...
// Example handlers (you can define these functions as needed)
